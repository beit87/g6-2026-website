---
layout: default
title: "Successo Maschile e Femminile 2"
...
I dati provengono dal dataset storico dei risultati olimpici (dettaglio atleta-evento e biografie degli atleti) incrociato con gli indicatori socio-economici della World Bank descritti nella pagina [Data Preparation]({{site.baseurl}}/data_preparation.html). Il genere di ogni evento è ricavato dal nome della gara (eventi *maschili*, *femminili* e *misti*), e negli sport di squadra ogni squadra conta una sola medaglia. La ricostruzione del medagliere è stata verificata contro quello ufficiale (correlazione ≈ 0,99).
...
<vegachart schema-url="{{site.baseurl}}/assets/charts/stefano2/01_partecipazione_e_quota.json" style="width: 100%; height: 100%"></vegachart>
</div>
<p>------------</p>
<br/>
...
<div style="height: 560px">
<vegachart schema-url="{{site.baseurl}}/assets/charts/stefano2/02_medagliere_e_quota.json" style="width: 100%; height: 100%"></vegachart>
</div>
<p>------------</p>
<br/>
...
<vegachart schema-url="{{site.baseurl}}/assets/charts/stefano2/03_top15_quota_femminile_paesi.json" style="width: 100%; height: 100%"></vegachart>
</div>
<p>------------</p>
<br/>
...
<vegachart schema-url="{{site.baseurl}}/assets/charts/stefano2/06_medagliere_principali_paesi_2000_2020.json" style="width: 100%; height: 100%"></vegachart>
</div>
<p>------------</p>
<br/>
...
<vegachart schema-url="{{site.baseurl}}/assets/charts/stefano2/05_scatter_pil_pro_capite_regressione.json" style="width: 100%; height: 100%"></vegachart>
</div>
<p>------------</p>
<br/>
...
Il genere degli eventi è ricavato dal parsing testuale del nome della gara; gli eventi misti sono tenuti separati e non redistribuiti. Le medaglie di squadra contano una volta per squadra. Le correlazioni presentate sono descrittive e non implicano relazioni causali; alcuni indicatori hanno il 20-40% di valori mancanti e quelli con copertura peggiore sono stati esclusi.
